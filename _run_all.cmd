...
@REM call python _run_all_linux.py
@REM call "C:\Program Files\WinRAR\WinRAR.exe" a -afzip "linux_reday.zip" ./solution_0.cpp ./testcases_gen.cpp ./testlib.h ./_run_all_linux.txt